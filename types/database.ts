...
export type TripUpdate = Partial<
  Omit<Trip, 'id' | 'user_id' | 'created_at' | 'updated_at' | 'share_token'>
>;

export type StepInsert = Omit<
  Step,
...
export type StepUpdate = Partial<
  Omit<Step, 'id' | 'trip_id' | 'created_at' | 'updated_at'>
>;

export type AccommodationInsert = Omit<
  Accommodation,
  'id' | 'created_at' | 'updated_at'
>;
export type AccommodationUpdate = Partial<
  Omit<Accommodation, 'id' | 'step_id' | 'created_at' | 'updated_at'>
>;
